...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Facade = __webpack_require__(191);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WebChannel = __webpack_require__(192);

	var _WebChannel2 = _interopRequireDefault(_WebChannel);

	var _ServiceProvider = __webpack_require__(194);
	...
	var Facade = function () {
	  ...
	  _createClass(Facade, [{
	    ...
	    value: function join(key) {
	      ...
	      var protocol = _ServiceProvider2.default.get('ExchangeProtocolService');
	      return new Promise(function (resolve, reject) {
	        connector.join(key).then(function (channel) {
	          var webChannel = new _WebChannel2.default({ connector: settings.connector });
	...
	var WebChannel = function () {
	  ...
	  _createClass(WebChannel, [{
	    ...
	    value: function send(data) {
	      var protocol = _ServiceProvider2.default.get(this.protocol);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FullyConnectedService = __webpack_require__(195);

	var _FullyConnectedService2 = _interopRequireDefault(_FullyConnectedService);

	var _WebRTCService = __webpack_require__(196);

	var _WebRTCService2 = _interopRequireDefault(_WebRTCService);

	var _ExchangeProtocolService = __webpack_require__(197);
	      ...
	      return new Promise(function (resolve, reject) {
	        ...
	        if (webChannel.channels.size === 0) {
	          ...
	          (function () {
	            ...
	            var connector = _ServiceProvider2.default.get('WebRTCService');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WebRTCService = function () {
	  function WebRTCService() {
	    ...
	    this.protocol = _ServiceProvider2.default.get('ExchangeProtocolService');
	    this.defaults = {
